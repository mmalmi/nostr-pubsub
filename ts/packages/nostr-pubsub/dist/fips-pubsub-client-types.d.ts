...
export type FipsNostrPubsubEventHandler = (event: NostrVerifiedEvent, sourcePeer: string) => void;
export declare function defaultFipsNostrPubsubClientLimits(): FipsNostrPubsubClientLimits;
//# sourceMappingURL=fips-pubsub-client-types.d.ts.map