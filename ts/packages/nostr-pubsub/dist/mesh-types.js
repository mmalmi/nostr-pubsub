...
import { DEFAULT_INV_WANT_FANOUT, DEFAULT_INV_WANT_MAX_EVENT_BYTES, } from './mesh-codec.js';
...
export function normalizeInvWantMeshOptions(options) {
    ...
    return {
        ...
        maxCachedEventBytes: Math.max(boundedPositive(merged.maxCachedEventBytes), boundedPositive(merged.maxEventBytes)),
