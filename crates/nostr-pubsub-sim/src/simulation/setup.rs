...
fn initial_report(
    ...
    SimulationReport {
        ...
        node_roles: topology.roles.clone(),
...
const EMPTY_REPORT_CONFIG: SimulationConfig = SimulationConfig {
    ...
    legitimate_publication_rounds: 0,
...
const EMPTY_REPORT_TEMPLATE: SimulationReport = SimulationReport {
    ...
    delivery_path_samples: 0,
    multihop_interested_deliveries: 0,
    multihop_interested_delivery_basis_points: 0,
    delivery_path_hops_p50: 0,
    delivery_path_hops_p95: 0,
    delivery_path_hops_p99: 0,
    delivery_path_hops_max: 0,
    ...
    verified_delivery_records: Vec::new(),
};
